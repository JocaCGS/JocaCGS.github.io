<script>
    ...
    let tarefaInput = "teste"
    let prazoInput = "teste"
    let prioridadeInput = "teste"
    let descricaoInput = "teste"
    let idInput = 4
...
<main>
	...
	<Tabela data={data} remove_func={deleteData}/>
    
    {#if show}
        <div transition:fade>
            <Dialogo close_func={close}/>
        </div>
    {/if}
