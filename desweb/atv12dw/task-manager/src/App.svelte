    <script>
        ...
        function addTabela(){
            ...
            let arr = {id: idInput++, tarefa: tarefaInput, descricao: descricaoInput, prioridade: prioridadeInput, prazo: prazoInput, status: false}
        ...
        let idInput = Math.max(...data.map(t => t.id)) + 1;
            ...
            function collectData(id) {
                itemobj = data.find(item => item.id === id);
                show = true;
            }       
    ...
    <main>
        ...
        <div class="form-inputs">
            <div class="grid-auto">
                <div>
                    ...
                    <input type="text" name="tarefa" bind:value={tarefaInput}/>
                </div>
                <div>
                    <label for="prazo">Prazo</label>
                    <input type="date" name="prazo" bind:value={prazoInput}/>
                </div>
                <div>
                    <label for="prioridade">Prioridade</label>
                    <select name="prioridade" bind:value={prioridadeInput}>
            ...
            <div class="grid-conf">
                <div>
                    ...
                    <textarea name="descricao" bind:value={descricaoInput}></textarea>
                </div>
                <div class="div-btn">
                    <button on:click={addTabela}>
        ...
        <Tabela data={data} remove_func={deleteData} collect_func={collectData}/>
        
        {#if show}
            <div transition:fade>
                <Dialogo itemdata={itemobj} close_func={close}/>
            </div>
        {/if}
